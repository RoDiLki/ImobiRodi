...
mix
    ...
    .styles([
        ...
        'resources/views/admin/assets/js/alertify/css/alertify.min.css',
        'resources/views/admin/assets/js/alertify/css/themes/bootstrap.min.css'
    ],'public/backend/assets/css/libs.css')

    .styles([
        'resources/views/admin/assets/js/alertify/css/alertify.min.css',
        'resources/views/admin/assets/js/alertify/css/themes/bootstrap.min.css'
    ],'public/backend/assets/css/libs_login.css')
    ...
    .scripts([
        'resources/views/admin/assets/js/alertify/alertify.min.js',
